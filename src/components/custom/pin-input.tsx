...
interface PinInputProps {
  ...
  | Array<React.ReactElement<typeof PinInputField>>
  /**
    ...
    const clones = validChildren.map((child) => {
      if (child.type === PinInputField) {
        ...
        return React.cloneElement(child, {
          ...
          onKeyDown: (e: React.KeyboardEvent<HTMLInputElement>) => { handlers.handleKeyDown(e, pinIndex) },
...
const usePinInput = ({
  ...
  const [pins, setPins] = React.useState<Array<string | number>>(pinInputs)
